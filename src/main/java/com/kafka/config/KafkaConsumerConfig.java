...
public class KafkaConsumerConfig {
    ...
    // 🔹 Consumer Factory for Transaction
    @Bean
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> transactionKafkaListenerFactory() {
    ...
    // 🔹 Consumer Factory for Notification
    @Bean
